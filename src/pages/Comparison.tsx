...
const Comparison: React.FC = () => {
  return (
    <div
      ...
      style={{
        backgroundImage:
          'url(/lovable-uploads/0b9933c1-1a2b-48be-a2dd-99bc9eee0647.png)',
      ...
      <SidebarProvider defaultOpen={true}>
        <div className="min-h-screen flex w-full">
          ...
          <SidebarInset className="flex-1">
            ...
            <div className="bg-[rgba(246,247,255,1)] relative z-20 w-full px-4 lg:px-6 py-2">
              <div className="max-w-[1600px] mx-auto flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-4 lg:gap-8">
                  <nav
                    className="flex items-center gap-4 lg:gap-8 text-[15px] lg:text-[17px] text-white tracking-[-0.34px]"
                    role="navigation"
                  ...
                  >
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent
                        align="start"
                        className="bg-white border border-gray-200 shadow-lg rounded-md min-w-[150px] z-50 mt-2"
                      >
                    ...
                    <button
                      className="w-6 lg:w-8 h-6 lg:h-8 hover:opacity-80 transition-opacity"
            ...
            {/* Main content */}
            <main
              className="flex-1 p-6 bg-white/80 backdrop-blur-sm"
              role="main"
            >

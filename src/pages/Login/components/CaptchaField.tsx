  ...
  return (
    <div className="space-y-[0.5vh]">
      ...
      <div className="flex items-center gap-[2vw] mb-[1.5vh]">
        <div className="text-[clamp(1rem,2vw,1.25rem)] font-extrabold italic tracking-wider text-black font-gilroy p-[1vh] rounded-lg flex gap-1 bg-transparent select-none">
        ...
        <Button
          ...
          onClick={onRefresh}
          type="button"
          className="h-[4vh] w-[4vh] min-h-[32px] min-w-[32px] rounded-lg flex items-center justify-center border-[#bcbec0] hover:bg-gray-50"
        >
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className="w-[2vh] h-[2vh] min-w-[12px] min-h-[12px]">
            <path

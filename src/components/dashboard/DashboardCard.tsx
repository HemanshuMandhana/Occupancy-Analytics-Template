...
export const DashboardCard: React.FC<DashboardCardProps> = ({ title, children, className = '' }) => {
  return (
    <article className={`bg-[rgba(247,248,255,1)] border flex min-h-[350px] lg:min-h-[389px] flex-col overflow-hidden items-stretch w-full px-4 lg:px-[23px] py-6 lg:py-[38px] rounded-xl border-[rgba(37,57,120,1)] border-solid ${className}`}>

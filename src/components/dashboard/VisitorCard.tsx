      ...
      <div className="flex items-start gap-3 mb-3">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2">
            <span className="text-gray-500 text-sm">Total Count</span>
            <div className="bg-[rgba(189,203,253,0.3)] border border-[rgba(39,60,134,1)] rounded px-2 py-1">
              <span className="text-[rgba(33,63,172,1)] text-lg font-bold">693</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <table className="w-full table-fixed h-full">
          <thead>
            <tr className="bg-[rgba(37,56,120,1)] text-white">
              <th className="w-1/4 px-2 py-2 text-center font-medium border-r border-gray-300 text-xs">Entrance</th>
              <th className="w-1/4 px-2 py-2 text-center font-medium border-r border-gray-300 text-xs">Visitors</th>
              <th className="w-1/4 px-2 py-2 text-center font-medium border-r border-gray-300 text-xs">Entrance</th>
              <th className="w-1/4 px-2 py-2 text-center font-medium text-xs">Visitors</th>
            </tr>
          </thead>
          <tbody>

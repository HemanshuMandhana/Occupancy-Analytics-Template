        ...
        <table className="w-full table-fixed">
          <thead>
            <tr className="bg-[rgba(37,56,120,1)] text-white">
              <th className="w-1/4 px-4 py-3 text-center font-medium border-r border-gray-300">Entrance</th>
              <th className="w-1/4 px-4 py-3 text-center font-medium border-r border-gray-300">Visitors</th>
              <th className="w-1/4 px-4 py-3 text-center font-medium border-r border-gray-300">Entrance</th>
              <th className="w-1/4 px-4 py-3 text-center font-medium">Visitors</th>
            </tr>
          </thead>
          <tbody>

    ...
    >
      <div className="flex items-center justify-between h-full px-4 lg:px-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <h1 className="sm:hidden text-black text-lg font-semibold absolute left-1/2 transform -translate-x-1/2">
            {pageTitle}
          </h1>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="sm:hidden flex items-center gap-3">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="w-10 h-10 bg-[rgba(37,56,120,1)] text-white rounded-full hover:bg-[rgba(37,56,120,0.9)] transition-colors flex items-center justify-center text-sm font-semibold flex-shrink-0">
                  R
                </button>
              </DropdownMenuTrigger>
              <DropdownMenuContent align="end" className="bg-white border border-gray-200 shadow-lg rounded-md mt-2">
